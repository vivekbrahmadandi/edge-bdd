package com.ta.test.step_definitions.gui.register;


import com.ta.test.enums.PermittedCharacters;
import com.ta.test.framework.helpers.utils.RandomGenerator;
import com.ta.test.page_objects.gui.NewRegistrationPage;
