...
Feature: SearchCandidate:- User should be able to perform candidate search and results should be in accordance with the business rules
  ...
  Scenario: Check if user can search through single group selection
    ...
    And user selects the group item "IBM profiles"
    And user enters the search candidate "krishna"
